...
const AboutUs = () => {
    ...
    return (
        ...
        >
            <div className="prose prose-blue max-w-4xl mx-auto py-8 text-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    <div className="flex flex-col items-center text-center p-6 bg-blue-50 rounded-xl">
                        ...
                        <h3 className="font-bold mb-2">{t('about.privacyTitle')}</h3>
                    ...
                    <div className="flex flex-col items-center text-center p-6 bg-green-50 rounded-xl">
                        ...
                        <h3 className="font-bold mb-2">{t('about.securityTitle')}</h3>
                        <p className="text-sm text-muted-foreground">{t('about.securityText')}</p>
                    </div>
                </div>

                <div className="border-t border-secondary/30 my-12"></div>

                <section className="mb-12">
                    <h2 className="text-2xl font-bold mb-6">{t('about.devTitle')}</h2>
            ...
            <SEO title="About" description="Learn about the mission and developer behind PDFNeo." />
        </ToolLayout>
    );
};
